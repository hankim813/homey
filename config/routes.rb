Rails.application.routes.draw do
  ...
  get 'api/users/show' => 'users#show', defaults: { format: 'json'}
  get 'api/users/edit' => 'users#edit', defaults: { format: 'json'}
  get 'api/users/delete' => 'users#delete', defaults: { format: 'json'}
